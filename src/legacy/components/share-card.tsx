      ...
      >
        <View style={styles.top}>
          ...
          <ThemedText
            ...
            // Six lines of a 29pt handwritten headline is the whole top half.
            // Anything longer is a headline that failed, and shrinking is
            ...
            {card.from ? (
              <>
                ...
                <ThemedText
                  style={[
                    styles.arrow,
                    { fontSize: 24 * scale, color: palette.textMuted },
                  ]}
                >
                  →
                </ThemedText>
  ...
  return (
    <View style={styles.figure}>
      <ThemedText
        style={[
          styles.value,
          { fontSize: 33 * scale, lineHeight: 39 * scale, color },
        ]}
        numberOfLines={1}
        adjustsFontSizeToFit
