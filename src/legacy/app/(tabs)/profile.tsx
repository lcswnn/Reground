...
export default function ProfileScreen() {
  ...
  // Anonymous accounts carry no name and no email — there is no screen left in
  // the app that asks for either. `display_name` is still read rather than
  // dropped: profiles created before the sign-up screen was removed still have
  // one, and it costs nothing to keep honouring it.
  const displayName =
      ...
      <SafeAreaView edges={['top']} style={styles.flex}>
        <ScrollView
          ...
          <View style={styles.header}>
            ...
            {/* Name only. The line under it used to be the account's email,
                and there is no account to have one — the day count that would
                be the obvious replacement is already a tile directly below. */}
